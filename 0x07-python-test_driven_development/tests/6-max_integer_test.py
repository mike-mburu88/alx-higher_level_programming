...
class TestMaxInteger(unittest.TestCase):
    """Create a test class for max_integer"""
    def test_module_docstring(self):
        """method for the docstring test module"""
        m = ___import__('6-max_integer').__doc__
    ...
    def test_no_args(self):
        """Test check if there are no arguments passed"""
        self.assertIsNone(max_integer())


    def test_one_element(self):
        """Test checks if there is only 1 number in list"""
        o = [1]
